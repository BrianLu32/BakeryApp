...
namespace YenHoungBakery
{
    public partial class YenHuongCalc : Form
    {
        ...
        private string checkConnection = System.IO.Directory.GetCurrentDirectory() + "\\connectionFile.txt";
        ...
        private ArrayList cakePrices = new ArrayList();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            try
            {
                var connectionPath = File.ReadLines("connectionFile.txt").Last();
                if (!File.Exists(checkConnection))
                {
