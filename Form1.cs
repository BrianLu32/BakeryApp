...
namespace YenHoungBakery
{
    public partial class YenHuongCalc : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            try
            {
                //Gets project Directory for con-fig file and database connection
                ...
                string databaseConnection = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|\\YenHoungBakeryDB2003.mdb";

                using (StreamWriter sw = File.CreateText(checkConnection))
                {
                    sw.WriteLine(databaseConnection);
                    sw.Close();
                }
                ...
                //gets highest invoice number for auto invoice generation
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (checkPriceChange == 1)
                {
                    ...
                    cakeCommand.Parameters.AddWithValue("@DeoThapCamPrice", DeoThapCamPriceTxt.Text);
        ...
        private void CalculateButton_Click(object sender, EventArgs e)
        {
            ...
            //sets the program-entered 0s back into blanks for database
        ...
        private void SelectFileButton_Click(object sender, EventArgs e)
        {
            if (openFile.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    connection.ConnectionString = File.ReadLines(connectionString).Last();
